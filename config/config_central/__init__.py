...
if env.lower() == "staging":
    from config.config_central.config_staging import * # noqa
elif env.lower() == "production":
    from config.config_central.config_production import * # noqa
else:
    from config.config_central.config_default import * # noqa
